...
<head>
    ...
    <link rel="stylesheet" href="/public/static/admin/css/colorbox.css" type="text/css" />
    ...
    <div class="nav-outer">
        ...
        <div class="nav">
            <div class="table">
                ...
                <ul class="current"><li><a href="/admin/main"><b>Products</b><!--[if IE 7]><!--></a><!--<![endif]-->
                        <!--[if lte IE 6]><table><tr><td><![endif]-->
                        <div class="select_sub show">
                            <ul class="sub">
                                <li><a href="/admin/main">View all products</a></li>
                                <li class="sub_show"><a href="/admin/addproduct">Add product</a></li>
