	...
	<div class="wrap">
		...
		<form method="post" action="options.php">
			...
			<table class="form-table">
                ...
                <tr valign="top"><th scope="row"><?php _e( 'Web-сайт', 'sampletheme' ); ?></th>
                    <td>
                ...
                <tr valign="top"><th scope="row"><?php _e( 'Адресс', 'sampletheme' ); ?></th>
                    <td>
                        <input id="sample_theme_options[addrestext]" class="regular-text" type="text" name="sample_theme_options[addrestext]" value="<?php esc_attr_e( $options['addrestext'] ); ?>" />
                    </td>
                </tr>
